...
- **Lệnh cài đặt chính thức:** `npm install https://github.com/maxlogvn/finger-chromium` (không phải `npm install fingerprint-chromium-engine` vì chưa publish lên npm registry).
