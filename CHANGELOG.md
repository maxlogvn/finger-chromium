...
- **Xoá thư mục `tests/integration/`**: Thư mục này tồn tại nhưng trống, không có test nào. Dự án chỉ dùng `tests/unit/` (Vitest) và `tests/e2e/` (Playwright) để tránh nhầm lẫn.
